...
// Keep this marker. package.json sets "type": "commonjs", so without an explicit
// export esbuild classifies this entry as CJS and wraps the body in a __commonJS
// helper re-exported as `export default`. The marker forces ESM classification, so
// the emitted bundle stays a plain module that runs on load and assigns window.Renderer.
export {};
