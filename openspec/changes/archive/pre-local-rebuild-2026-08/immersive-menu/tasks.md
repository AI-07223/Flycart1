...
- [x] 1.2 `main.js`: menu state machine sub-states under `mode==="menu"` (main / hangar / tower / control / comms / howto) → each sets a camera target + which panel shows; cross-fade panels
- [x] 1.3 Camera choreography: smooth lerp/slerp between section framings; the slow home-base orbit at rest
...
- [x] 2.1 Build home-base structures (reuse/extend landmark builders): runway + idle plane, Hangar, Scoreboard Tower, Control Tower, Comms Pad
